...
def create_random_game() -> Game:
    """Run a game with one human player, and random player."""
    return Game(3, 1, 1, [])
...
def create_smart_game(smart_player_level) -> Game:
    """Run a sample game with one human player and one smart player
    of level smart_player_level
    """
    return Game(3, 1, 0, [smart_player_level])
